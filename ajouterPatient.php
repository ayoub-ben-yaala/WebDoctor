...
<?php include 'connexion.php' ?>
    ...
    <div class="container" style="width:900px;">
        <?php
            // Récupérer les informations du patient à partir du formulaire
            if (!empty($_POST)) {
                $nom            = $_POST['nom'];
                $prenom         = $_POST['prenom'];
                $dateN          = $_POST['dateN'];
                ...
                $sql = "INSERT INTO patient (nom,prenom,datenaissance,adresse,tel,maladie_chronique,cause_visite,user_id) VALUES (?, ?, ?, ?, ? ,? ,?,?)";
                // Envoi et exécution de la requête
                $res = $con->prepare($sql);
                $res->execute([$nom, $prenom, $dateN, $adresse, $tel ,$maladie ,$cause_visite,$id]);
        ...
        <hr>
        <fieldset>
                <legend><h2>Nouveau Patient</h2></legend>
            <hr>
